 ...
 * types it. Decode the whole record through `S.record(S.env)` and the coercions
 * are inferred: `"8080"` -> `S.port`, `"true"` -> `S.boolean`, a missing key or
 ...
 */
export const env: Schema<string | undefined, string>;
