...
test("toJSONSchema with target draft-07 stamps the draft-07 $schema", t => {
  t->Assert.deepEqual(
    S.string->S.toInputJSONSchemaOrThrow(~options={target: Draft07}),
...
test("toJSONSchema with target draft-2020-12 stamps the draft-2020-12 $schema", t => {
  t->Assert.deepEqual(
    S.string->S.toInputJSONSchemaOrThrow(~options={target: Draft202012}),
...
test("toJSONSchema with target openapi-3.0 omits $schema", t => {
  t->Assert.deepEqual(
    S.string->S.toInputJSONSchemaOrThrow(~options={target: OpenApi30}),
    %raw(`{"type": "string"}`),
  )
})
...
test("toJSONSchema with empty options defaults to draft-07 and stamps $schema", t => {
  t->Assert.deepEqual(
    S.string->S.toInputJSONSchemaOrThrow(~options={}),
    %raw(`{"$schema": "http://json-schema.org/draft-07/schema#", "type": "string"}`),
  )
})
...
test("toJSONSchema with an unsupported target throws", t => {
  ...
  t->Assert.throws(
    () => S.string->S.toInputJSONSchemaOrThrow(~options={target: Unknown("unsupported-target")}),
...
test("toJSONSchema tuple draft-07 uses an items array", t => {
  t->Assert.deepEqual(
    S.tuple2(S.string, S.bool)->S.toInputJSONSchemaOrThrow(~options={target: Draft07}),
    %raw(`{
...
test("toJSONSchema tuple draft-2020-12 uses prefixItems", t => {
  t->Assert.deepEqual(
    S.tuple2(S.string, S.bool)->S.toInputJSONSchemaOrThrow(~options={target: Draft202012}),
    %raw(`{
...
test("toJSONSchema tuple openapi-3.0 uses items anyOf", t => {
  t->Assert.deepEqual(
    S.tuple2(S.string, S.bool)->S.toInputJSONSchemaOrThrow(~options={target: OpenApi30}),
    %raw(`{
      "type": "array",
      "minItems": 2,
      "maxItems": 2,
...
test("toJSONSchema null draft-07 uses type null", t => {
  t->Assert.deepEqual(
    S.literal(%raw(`null`))->S.toInputJSONSchemaOrThrow(~options={target: Draft07}),
...
test("toJSONSchema null openapi-3.0 uses enum", t => {
  t->Assert.deepEqual(
    S.literal(%raw(`null`))->S.toInputJSONSchemaOrThrow(~options={target: OpenApi30}),
    %raw(`{"enum": [null]}`),
  )
})
...
test("toJSONSchema string literal draft-07 uses const", t => {
  t->Assert.deepEqual(
    S.literal("Hello")->S.toInputJSONSchemaOrThrow(~options={target: Draft07}),
...
test("toJSONSchema string literal openapi-3.0 uses enum", t => {
  t->Assert.deepEqual(
    S.literal("Hello")->S.toInputJSONSchemaOrThrow(~options={target: OpenApi30}),
...
test("toJSONSchema number literal openapi-3.0 uses enum", t => {
  t->Assert.deepEqual(
    S.literal(123)->S.toInputJSONSchemaOrThrow(~options={target: OpenApi30}),
...
test("toJSONSchema boolean literal openapi-3.0 uses enum", t => {
  t->Assert.deepEqual(
    S.literal(true)->S.toInputJSONSchemaOrThrow(~options={target: OpenApi30}),
...
test("toJSONSchema nullable float draft-07 keeps anyOf with type null", t => {
  t->Assert.deepEqual(
    S.nullAsOption(S.float)->S.toInputJSONSchemaOrThrow(~options={target: Draft07}),
    %raw(`{
      "$schema": "http://json-schema.org/draft-07/schema#",
...
test("toJSONSchema nullable float openapi-3.0 collapses to nullable", t => {
  t->Assert.deepEqual(
    S.nullAsOption(S.float)->S.toInputJSONSchemaOrThrow(~options={target: OpenApi30}),
...
test("toJSONSchema exclusive bound draft-07 uses the numeric keyword", t => {
  t->Assert.deepEqual(
    S.float->S.gt(5.)->S.toInputJSONSchemaOrThrow(~options={target: Draft07}),
    %raw(`{
      "$schema": "http://json-schema.org/draft-07/schema#",
      "type": "number",
      "exclusiveMinimum": 5
...
test("toJSONSchema exclusive bound openapi-3.0 uses the draft-04 boolean form", t => {
  t->Assert.deepEqual(
    S.float->S.gt(5.)->S.toInputJSONSchemaOrThrow(~options={target: OpenApi30}),
...
test("toJSONSchema exclusive upper bound openapi-3.0 uses the draft-04 boolean form", t => {
  t->Assert.deepEqual(
    S.float->S.lt(5.)->S.toInputJSONSchemaOrThrow(~options={target: OpenApi30}),
...
test("toJSONSchema keeps both bounds when only one is exclusive", t => {
  t->Assert.deepEqual(
    S.float->S.gte(0.)->S.lt(5.)->S.toInputJSONSchemaOrThrow(~options={target: Draft07}),
    %raw(`{
      "$schema": "http://json-schema.org/draft-07/schema#",
      "type": "number",
      "minimum": 0,
...
test("toJSONSchema of a JSON string describes the document it carries", t => {
  ...
  t->Assert.deepEqual(
    schema->S.toInputJSONSchemaOrThrow(~options={target: Draft07}),
    %raw(`{
      "$schema": "http://json-schema.org/draft-07/schema#",
      "type": "string",
  ...
  t->Assert.deepEqual(
    schema->S.toInputJSONSchemaOrThrow(~options={target: Draft202012}),
    %raw(`{
      "$schema": "https://json-schema.org/draft/2020-12/schema",
      "type": "string",
      "contentMediaType": "application/json",
  ...
  t->Assert.deepEqual(
    schema->S.toInputJSONSchemaOrThrow(~options={target: OpenApi30}),
    %raw(`{"type": "string"}`),
  )
})
...
test("toJSONSchema of a schema decoding to a blob follows the target's spelling", t => {
  ...
  t->Assert.deepEqual(
    upload->S.toInputJSONSchemaOrThrow(~options={target: OpenApi30}),
    %raw(`{"type": "string", "format": "binary"}`),
  )

  t->Assert.deepEqual(
    upload->S.toInputJSONSchemaOrThrow(~options={target: Draft202012}),
    %raw(`{
      "$schema": "https://json-schema.org/draft/2020-12/schema",
      "type": "string",
  ...
  t->Assert.deepEqual(
    ...
    ->S.toInputJSONSchemaOrThrow(~options={target: OpenApi30}),
...
test("toJSONSchema of a binary instance still has no document at all", t => {
  ...
  t->Assert.throws(
    () => S.blob->S.toInputJSONSchemaOrThrow(~options={target: OpenApi30})->ignore,
...
test("toJSONSchema of a JSON string keeps converting when the document has no JSON Schema", t => {
  ...
  t->Assert.deepEqual(
    (S.jsonString->S.to(S.bigint))->S.toInputJSONSchemaOrThrow(~options={target: Draft202012}),
    %raw(`{
      "$schema": "https://json-schema.org/draft/2020-12/schema",
      "type": "string",
      "contentMediaType": "application/json"
  ...
  t->Assert.deepEqual(
    (S.jsonString->S.to(S.uint8Array))->S.toInputJSONSchemaOrThrow(~options={target: Draft202012}),
    %raw(`{
      "$schema": "https://json-schema.org/draft/2020-12/schema",
      "type": "string",
      "contentMediaType": "application/json"
...
test("toJSONSchema of a JSON string omits contentSchema when the document is any JSON", t => {
  t->Assert.deepEqual(
    (S.jsonString->S.to(S.json))->S.toInputJSONSchemaOrThrow(~options={target: Draft202012}),
    %raw(`{
      "$schema": "https://json-schema.org/draft/2020-12/schema",
      "type": "string",
      "contentMediaType": "application/json"
...
test("toJSONSchema publishes the $defs a contentSchema reaches", t => {
  ...
  t->Assert.deepEqual(
    (S.jsonString->S.to(node))->S.toInputJSONSchemaOrThrow(~options={target: Draft202012}),
    %raw(`{
      "$schema": "https://json-schema.org/draft/2020-12/schema",
      "type": "string",
      "contentMediaType": "application/json",
