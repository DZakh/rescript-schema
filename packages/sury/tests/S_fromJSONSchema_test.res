...
// Helper for round-trip: S -> toInputJSONSchemaOrThrow -> fromJSONSchemaOrThrow -> S
let roundTrip = schema => schema->S.toInputJSONSchemaOrThrow->S.fromJSONSchemaOrThrow

// Helper for round-trip: JSONSchema -> fromJSONSchemaOrThrow -> toInputJSONSchemaOrThrow
let jsonRoundTrip = js => js->S.fromJSONSchemaOrThrow->S.toInputJSONSchemaOrThrow
...
test("fromJSONSchemaOrThrow: boolean definitions", t => {
  t->Assert.deepEqual(parse(S.fromJSONSchemaDefinitionOrThrow(Any), {"ok": true}), {"ok": true})
  t->Assert.throws(() => parse(S.fromJSONSchemaDefinitionOrThrow(Never), %raw("null")))
})

test("fromJSONSchemaOrThrow: string", t => {
...
test("fromJSONSchemaOrThrow: number", t => {
...
test("fromJSONSchemaOrThrow: integer", t => {
...
test("fromJSONSchemaOrThrow: boolean", t => {
...
test("fromJSONSchemaOrThrow: null", t => {
...
test("fromJSONSchemaOrThrow: const", t => {
...
test("fromJSONSchemaOrThrow: enum", t => {
...
test("fromJSONSchemaOrThrow: array of string", t => {
  let js = {
...
test("fromJSONSchemaOrThrow: array with minItems/maxItems", t => {
  let js = {
    type_: Arrayable.single(#array),
...
test("fromJSONSchemaOrThrow: tuple", t => {
  let js = {
    type_: Arrayable.single(#array),
...
test("fromJSONSchemaOrThrow: tuple via draft-2020-12 prefixItems", t => {
  let js = {
    type_: Arrayable.single(#array),
    prefixItems: [
      Schema({type_: Arrayable.single(#string)}),
...
test("fromJSONSchemaOrThrow: object with properties", t => {
  let js = {
...
test("fromJSONSchemaOrThrow: object with additionalProperties false", t => {
  let js = {
    type_: Arrayable.single(#object),
...
test("fromJSONSchemaOrThrow: object with additionalProperties true", t => {
  let js = {
    type_: Arrayable.single(#object),
...
test("fromJSONSchemaOrThrow: bare object with no properties or additionalProperties", t => {
...
test("fromJSONSchemaOrThrow: anyOf", t => {
  let js = {
...
test("fromJSONSchemaOrThrow: oneOf", t => {
  let js = {
...
test("fromJSONSchemaOrThrow: allOf", t => {
  let js = {
    allOf: [
...
test("fromJSONSchemaOrThrow: not", t => {
...
test("fromJSONSchemaOrThrow: nullable true", t => {
...
test("fromJSONSchemaOrThrow: nullable false", t => {
...
test("fromJSONSchemaOrThrow: string format email", t => {
...
test("fromJSONSchemaOrThrow: string format uuid", t => {
...
test("fromJSONSchemaOrThrow: string format date-time", t => {
...
test("Round-trip S.string->S.to(S.date) through toJSONSchema/fromJSONSchemaOrThrow", t => {
  let schema = S.string->S.to(S.date)
  let js = schema->S.toInputJSONSchemaOrThrow
  t->Assert.deepEqual(js, %raw(`{"type": "string", "format": "date-time"}`))
  // fromJSONSchemaOrThrow then toJSONSchema should preserve the format
  t->Assert.deepEqual(js->S.fromJSONSchemaOrThrow->S.toInputJSONSchemaOrThrow, js)
})

// All format schemas (including date-time) compose with sibling constraints.
test("fromJSONSchemaOrThrow: format date-time composes with sibling minLength/maxLength", t => {
  let js = {
...
test("fromJSONSchemaOrThrow: string pattern", t => {
...
test("fromJSONSchemaOrThrow: title, description, deprecated, examples", t => {
  let js = {
    type_: Arrayable.single(#string),
    title: "title",
    description: "desc",
...
test("fromJSONSchemaOrThrow: empty schema is any", t => {
  let js: JSONSchema.t = {}
  let schema = S.fromJSONSchemaOrThrow(js)
  t->Assert.deepEqual(parse(schema, "foo"), "foo")
  t->Assert.deepEqual(parse(schema, 1), 1)
...
test("fromJSONSchemaOrThrow: unknown type throws", t => {
  let js = {type_: Arrayable.single((Obj.magic("unknownType"): typeName))}
  t->Assert.throws(
    () => S.fromJSONSchemaOrThrow(js),
...
test("fromJSONSchemaOrThrow: a finite $ref inlines, and round-trips as what it inlined", t => {
  let js = {
    ref: "#/$defs/Name",
...
test("fromJSONSchemaOrThrow: draft-07 spells the same defs `definitions`", t => {
  let js = {
    type_: Arrayable.single(#array),
...
test("fromJSONSchemaOrThrow: a pointer resolves through any path, not just a defs dict", t => {
  ...
  t->Assert.deepEqual(parse(S.fromJSONSchemaOrThrow(js), "cat"), "cat")
})

test("fromJSONSchemaOrThrow: pointer segments are unescaped per RFC 6901", t => {
  let js: JSONSchema.t = %raw(`{
...
test("fromJSONSchemaOrThrow: a recursive $ref round-trips as a $ref plus its $defs", t => {
  let js: JSONSchema.t = %raw(`{
    "$ref": "#/$defs/Node",
    "$defs": {
      "Node": {
  ...
  t->Assert.deepEqual(parse(S.fromJSONSchemaOrThrow(out), {"next": Dict.make()}), {"next": Dict.make()})
})

test("fromJSONSchemaOrThrow: `#` points at the document itself", t => {
  let js: JSONSchema.t = %raw(`{
    "type": "object",
    "properties": {"self": {"$ref": "#"}}
  }`)
...
test("fromJSONSchemaOrThrow: a $ref resolves inside allOf, which compiles on its own", t => {
  let js: JSONSchema.t = %raw(`{
...
test("fromJSONSchemaOrThrow: an unresolvable $ref throws", t => {
  t->Assert.throws(
    () => S.fromJSONSchemaOrThrow({ref: "#/$defs/Missing"}),
    ~expectations={message: "Failed to resolve JSON Schema $ref: #/$defs/Missing"},
  )
})

test("fromJSONSchemaOrThrow: a $ref out of the document throws", t => {
  t->Assert.throws(
...
test("fromJSONSchemaOrThrow: a $ref to a non-schema value throws instead of widening to any", t => {
  ...
  t->Assert.throws(
    () => S.fromJSONSchemaOrThrow(%raw(`{"$ref": "#/$defs/N", "$defs": {"N": null}}`)),
    ~expectations={message: "Failed to resolve JSON Schema $ref: #/$defs/N"},
  )
  t->Assert.throws(
    () => S.fromJSONSchemaOrThrow(%raw(`{"$ref": "#/$defs/A/enum", "$defs": {"A": {"enum": [1]}}}`)),
    ~expectations={message: "Failed to resolve JSON Schema $ref: #/$defs/A/enum"},
  )
})

test("fromJSONSchemaOrThrow: a content-free $ref cycle throws instead of overflowing the stack", t => {
  t->Assert.throws(
    () => S.fromJSONSchemaOrThrow(%raw(`{"$ref": "#"}`)),
...
test("fromJSONSchemaOrThrow: a % that isn't percent-encoding resolves literally", t => {
  let js: JSONSchema.t = %raw(`{
    "$ref": "#/$defs/50%",
    "$defs": {"50%": {"type": "string"}}
  }`)
  t->Assert.deepEqual(parse(S.fromJSONSchemaOrThrow(js), "half"), "half")
})

test("fromJSONSchemaOrThrow: a recursive def whose name needs escaping round-trips resolvable", t => {
  let js: JSONSchema.t = %raw(`{
    "$ref": "#/$defs/a~1b",
    "$defs": {
  ...
  // same key; the document must feed fromJSONSchemaOrThrow again unchanged.
  let schema = S.fromJSONSchemaOrThrow(out)
  t->Assert.deepEqual(parse(schema, {"next": Dict.make()}), {"next": Dict.make()})
})

test("fromJSONSchemaOrThrow: an inlined ref releases its def name for a later cycle", t => {
  let js: JSONSchema.t = %raw(`{
    "type": "object",
    "properties": {
...
// 11. Round-trip S -> toInputJSONSchemaOrThrow -> fromJSONSchemaOrThrow -> S

test("fromJSONSchemaOrThrow: round-trip for string schema", t => {
  let orig = S.string
  let round = roundTrip(orig)
  t->Assert.deepEqual(parse(round, "foo"), "foo")
  t->Assert.throws(() => parse(round, 1))
  t->Assert.deepEqual(round->S.toInputJSONSchemaOrThrow, orig->S.toInputJSONSchemaOrThrow)
})

test("fromJSONSchemaOrThrow: round-trip for object schema", t => {
