...
module CommonWithNested = {
  ...
  test("Compiled parse code snapshot", t => {
    ...
    t->U.assertCompiledCode(
      ~struct,
      ~op=#parse,
      `i=>{let v1;if(!i||i.constructor!==Object){e[0](i)}v1={};for(let v0 in i){let v3;try{v3=i[v0];if(typeof v3!=="string"){e[1](v3)}}catch(v2){if(v2&&v2.s===s){v2.path=""+'["'+v0+'"]'+v2.path}throw v2}v1[v0]=v3}return v1}`,
      (),
    )
  })
  ...
  test("Compiled async parse code snapshot", t => {
    ...
    t->U.assertCompiledCode(
      ~struct,
      ~op=#parse,
      `i=>{let v1,v9;if(!i||i.constructor!==Object){e[0](i)}v1={};for(let v0 in i){let v3,v4;try{v3=e[1](i[v0]);v4=()=>{try{return v3().catch(v2=>{if(v2&&v2.s===s){v2.path=""+'["'+v0+'"]'+v2.path}throw v2})}catch(v2){if(v2&&v2.s===s){v2.path=""+'["'+v0+'"]'+v2.path}throw v2}};}catch(v2){if(v2&&v2.s===s){v2.path=""+'["'+v0+'"]'+v2.path}throw v2}v1[v0]=v4}v9=()=>new Promise((v5,v6)=>{let v8=Object.keys(v1).length;for(let v0 in v1){v1[v0]().then(v7=>{v1[v0]=v7;if(v8--===1){v5(v1)}},v6)}});return v9}`,
      (),
    )
  })
