...
module CommonWithNested = {
  ...
  test("Compiled parse code snapshot", t => {
    ...
    t->U.assertCompiledCode(
      ~schema,
      ~op=#Parse,
      `i=>{if(!i||i.constructor!==Object){e[1](i)}for(let v0 in i){let v1=i[v0];try{if(typeof v1!=="string"){e[0](v1)}}catch(v2){if(v2&&v2.s===s){v2.path=""+\'["\'+v0+\'"]\'+v2.path}throw v2}}return i}`,
    )
  })
  ...
  test("Compiled serialize code snapshot with transform", t => {
    let schema = S.dict(S.string->S.trim)

    t->U.assertCompiledCode(
      ~schema,
      ~op=#Serialize,
      `i=>{let v3={};for(let v0 in i){let v2;try{v2=e[0](i[v0])}catch(v1){if(v1&&v1.s===s){v1.path=""+\'["\'+v0+\'"]\'+v1.path}throw v1}v3[v0]=v2}return v3}`,
    )
  })
}
