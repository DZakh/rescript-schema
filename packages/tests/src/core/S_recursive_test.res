...
test("Parses multiple nested recursive object inside of another object", t => {
  ...
  t->U.assertCompiledCode(
    ~schema,
    ~op=#Parse,
    `i=>{if(!i||i.constructor!==Object){e[8](i)}let v0=i["recursive1"],v9,v10=i["recursive2"],v19;if(!v0||v0.constructor!==Object){e[0](v0)}if(!v10||v10.constructor!==Object){e[4](v10)}let r0=v0=>{let v1=v0["Id"],v2=v0["Children"],v7=[];if(typeof v1!=="string"){e[1](v1)}if(!Array.isArray(v2)){e[2](v2)}for(let v3=0;v3<v2.length;++v3){let v6;try{let v5=v2[v3];if(!v5||v5.constructor!==Object){e[3](v5)}v6=r0(v5)}catch(v4){if(v4&&v4.s===s){v4.path="[\\"Children\\"]"+\'["\'+v3+\'"]\'+v4.path}throw v4}v7.push(v6)}return {"id":v1,"children":v7,}};try{v9=r0(v0)}catch(v8){if(v8&&v8.s===s){v8.path="[\\"recursive1\\"]"+v8.path}throw v8}let r1=v10=>{let v11=v10["Id"],v12=v10["Children"],v17=[];if(typeof v11!=="string"){e[5](v11)}if(!Array.isArray(v12)){e[6](v12)}for(let v13=0;v13<v12.length;++v13){let v16;try{let v15=v12[v13];if(!v15||v15.constructor!==Object){e[7](v15)}v16=r1(v15)}catch(v14){if(v14&&v14.s===s){v14.path="[\\"Children\\"]"+\'["\'+v13+\'"]\'+v14.path}throw v14}v17.push(v16)}return {"id":v11,"children":v17,}};try{v19=r1(v10)}catch(v18){if(v18&&v18.s===s){v18.path="[\\"recursive2\\"]"+v18.path}throw v18}return {"recursive1":v9,"recursive2":v19,}}`,
  )
