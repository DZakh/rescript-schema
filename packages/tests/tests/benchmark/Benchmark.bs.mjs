...
function makeAdvancedStrictObjectStruct() {
  return S.$$Object.strict(S.object(function (s) {
                  return {
                          number: s.f("number", S.$$float),
                          negNumber: s.f("negNumber", S.$$float),
                          maxNumber: s.f("maxNumber", S.$$float),
                          ...
                          longString: s.f("longString", S.string),
                          boolean: s.f("boolean", S.bool),
                          deeplyNested: s.f("deeplyNested", S.$$Object.strict(S.object(function (s) {
                                        return {
                                                foo: s.f("foo", S.string),
                                                num: s.f("num", S.$$float),
                                                bool: s.f("bool", S.bool)
...
run(addWithPrepare(addWithPrepare(addWithPrepare(addWithPrepare(addWithPrepare(addWithPrepare(new (Benchmark.default.Suite)(), "Parse string", (function () {
                                  return function () {
                                    return S.parseAnyOrRaiseWith("Hello world!", S.string);
                                  };
                                })), "Serialize string", (function () {
                              return function () {
                                return S.serializeOrRaiseWith("Hello world!", S.string);
                              };
