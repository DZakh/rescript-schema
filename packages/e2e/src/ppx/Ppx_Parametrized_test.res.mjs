...
Vitest$1.test("Record using parametrized type as field", t => Vitest.Assert.deepEqual(t, Sury.parseOrThrow({"wrapped": {"value": 42}}, parentSchema), {
  wrapped: {
    value: 42
  }
}, undefined));
...
Vitest$1.test("Nested parametrized types", t => {
  ...
  Vitest.Assert.deepEqual(t, Sury.parseOrThrow({"inner": {"value": "deep"}}, schema), {
    inner: {
      value: "deep"
    }
  }, undefined);
...
Vitest$1.test("Parametrized type with option field", t => {
  ...
  Vitest.Assert.deepEqual(t, Sury.parseOrThrow({"data": 5}, schema), {
    data: 5
  }, undefined);
});
...
Vitest$1.test("Parametrized type with array field", t => {
  ...
  Vitest.Assert.deepEqual(t, Sury.parseOrThrow({"items": ["a", "b", "c"]}, schema), {
    items: [
      "a",
      "b",
      "c"
...
Vitest$1.test("Record field with @s.matches override for a 2-param type", t => {
  Vitest.Assert.deepEqual(t, Sury.parseOrThrow({"res": {"TAG": "R2A", "_0": 1}}, holderSchema), {
    res: {
      TAG: "R2A",
      _0: 1
    }
  }, undefined);
  Vitest.Assert.deepEqual(t, Sury.parseOrThrow({"res": {"TAG": "R2B", "_0": "boom"}}, holderSchema), {
    res: {
      TAG: "R2B",
      _0: "boom"
    }
...
Vitest$1.test("Parametrized type alias whose param is unused (phantom)", t => {
  ...
  Vitest.Assert.deepEqual(t, Sury.parseOrThrow("hello", schema), "hello", undefined);
});
