...
function getMaybeFieldNameOverride(builderCtx, idx) {
  return Js_dict.get(builderCtx.nameOverrides, idx.toString());
}

function field(builderCtx, maybeNameOverride, struct) {
  addFieldUsage(builderCtx, struct, maybeNameOverride);
  return value;
}

function fromBuilderResult(builderResult, builderCtx) {
  ...
  var fieldStructs = builderCtx.structs;
  ...
  return {
          fieldNameParseOverrides: fieldNameParseOverrides,
...
function factory$3(builder) {
  ...
  var match = fromBuilderResult(Curry._1(builder, builderCtx), builderCtx);
  var originalFieldNames = match.originalFieldNames;
  var originalFields = match.originalFields;
  var fieldNameParseOverrides = match.fieldNameParseOverrides;
  return make("Object", {
              TAG: /* Object */4,
              ...
              fieldNames: originalFieldNames
                ...
                planSyncTransformation(ctx, (new Function('syncOps', 'originalFields', 'raiseUnexpectedTypeError','raiseOnExcessField', 'catchFieldError', 'return ' + syncTransformation))(syncOps, originalFields, raiseUnexpectedTypeError, (function (exccessFieldName) {
                          ...
                          }), syncTransformation, syncTransformation));
              }), (function (ctx, param) {
