...
function parse(data) {
  var struct = this;
  try {
    return fromOk(S.parseAnyOrRaiseWith(data, struct));
  }
  catch (raw_error){
...
function parseAsync(data) {
  var struct = this;
  return S.parseAnyAsyncWith(data, struct).then(function (result) {
              if (result.TAG === "Ok") {
...
function serialize(value) {
  var struct = this;
  try {
    return fromOk(S.serializeToUnknownOrRaiseWith(value, struct));
  }
  catch (raw_error){
    var error = Caml_js_exceptions.internalToOCamlException(raw_error);
    if (error.RE_EXN_ID === S.Raised) {
...
function transform(maybeParser, maybeSerializer) {
  var struct = this;
  var struct$1 = S.transform(struct, (function (s) {
          var struct = s.s;
...
function refine(refiner) {
  var struct = this;
  var struct$1 = S.refine(struct, (function (s) {
          var struct = s.s;
          var effectCtx_struct = Object.assign(struct, structOperations);
          var effectCtx_fail = function (message) {
            return s.f(undefined, message);
...
function asyncParserRefine(refiner) {
  var struct = this;
  var struct$1 = S.asyncParserRefine(struct, (function (s) {
          var struct = s.s;
          var effectCtx_struct = Object.assign(struct, structOperations);
          var effectCtx_fail = function (message) {
            return s.f(undefined, message);
...
function describe(description) {
  var struct = this;
  var struct$1 = S.describe(struct, description);
  return Object.assign(struct$1, structOperations);
}

function description() {
  var struct = this;
  return S.description(struct);
}

function $$default(def) {
  var struct = this;
  var struct$1 = S.$$default(struct, def);
  return Object.assign(struct$1, structOperations);
}
...
function jsonString(struct) {
  var struct$1 = S.jsonString(struct);
  return Object.assign(struct$1, structOperations);
}
...
function literal(literal$1) {
  ...
  var struct = S.literal(literal$1);
  return Object.assign(struct, structOperations);
}

function custom(name, maybeParser, maybeSerializer, param) {
  var struct = S.custom(name, (function (s) {
          var struct = s.s;
          var effectCtx_struct = Object.assign(struct, structOperations);
          var effectCtx_fail = function (message) {
            return s.f(undefined, message);
...
var string = Object.assign(S.string, structOperations);

var $$boolean = Object.assign(S.bool, structOperations);

var integer = Object.assign(S.$$int, structOperations);

var number = Object.assign(S.$$float, structOperations);

var never = Object.assign(S.never, structOperations);

var unknown = Object.assign(S.unknown, structOperations);

var json = Object.assign(S.json, structOperations);

var struct = S.variant(S.literal(NaN), (function (param) {
...
function strict() {
  var struct = this;
  return Object.assign(S.$$Object.strict(struct), objectStructOperations);
}

function strip() {
  var struct = this;
  return Object.assign(S.$$Object.strip(struct), objectStructOperations);
}

function factory(definer) {
  return Object.assign(S.object(function (s) {
                  var definition = {};
